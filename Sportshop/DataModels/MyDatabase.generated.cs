...
namespace DataModels
{
	...
	/// </summary>
	public partial class SpeedoDB : LinqToDB.Data.DataConnection
	{
		public ITable<Card>     Cards     { get { return this.GetTable<Card>(); } }
		public ITable<Category> Categorys { get { return this.GetTable<Category>(); } }
		public ITable<Genders>  Genderss  { get { return this.GetTable<Genders>(); } }
		public ITable<Products> Productss { get { return this.GetTable<Products>(); } }
		public ITable<Users>    Userss    { get { return this.GetTable<Users>(); } }
		...
		public SpeedoDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public ITable<GenerateSeriesResult> GenerateSeries(DateTimeOffset? par1887, DateTimeOffset? par1888, TimeSpan? par1889)
		{
		...
		public ITable<PgExpandarrayResult> PgExpandarray(object par4886)
		{
		...
		public partial class PgGetReplicationSlotsResult
		{
			...
			public object confirmed_flush_lsn { get; set; }
		}
		...
		public ITable<PgLsDirResult> PgLsDir(string par5023, bool? par5024, bool? par5025)
		{
		...
		public partial class PgStatGetWalSendersResult
		{
			public int?      pid           { get; set; }
			public string    state         { get; set; }
			public object    sent_lsn      { get; set; }
			public object    write_lsn     { get; set; }
			public object    flush_lsn     { get; set; }
			public object    replay_lsn    { get; set; }
			public TimeSpan? write_lag     { get; set; }
			public TimeSpan? flush_lag     { get; set; }
			public TimeSpan? replay_lag    { get; set; }
		...
		public ITable<PgTablespaceDatabasesResult> PgTablespaceDatabases(int? par5309)
		{
		...
		public ITable<RegexpMatchesResult> RegexpMatches(string par5794, string par5795, string par5796)
		{
		...
		public ITable<RegexpSplitToTableResult> RegexpSplitToTable(string par5815, string par5816, string par5817)
		{
		...
		public ITable<TxidSnapshotXipResult> TxidSnapshotXip(object par7218)
		{
	...
	public partial class Card
	{
		...
		[Column("product_id"), NotNull              ] public int     ProductId { get; set; } // integer
		[Column("user_id"),    NotNull              ] public int     UserId    { get; set; } // integer
		[Column("amount"),        Nullable          ] public int     Amount    { get; set; } // integer

		#region Associations

		/// <summary>
		/// card_product_id_fkey
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="card_product_id_fkey", BackReferenceName="Cardproductidfkeys")]
		public Products Product { get; set; }

		/// <summary>
		/// card_user_id_fkey
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="card_user_id_fkey", BackReferenceName="Carduseridfkeys")]
	...
	public partial class Category
	{
		...
		/// <summary>
		/// products_category_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="CategoryId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Products> Productsidfkeys { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="genders")]
	...
	public partial class Products
	{
		...
		[Column("photo"),          Nullable          ] public string Photo       { get; set; } // character varying
		[Column("category_id"), NotNull              ] public int    CategoryId  { get; set; } // integer
		[Column("gender_id"),   NotNull              ] public int    GenderId    { get; set; } // integer

		#region Associations

		/// <summary>
		/// card_product_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ProductId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Card> Cardproductidfkeys { get; set; }

		/// <summary>
		/// products_category_id_fkey
		/// </summary>
		[Association(ThisKey="CategoryId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="products_category_id_fkey", BackReferenceName="Productsidfkeys")]
		public Category Category { get; set; }

		/// <summary>
		/// products_gender_id_fkey
		/// </summary>
		[Association(ThisKey="GenderId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="products_gender_id_fkey", BackReferenceName="Productsgenderidfkeys")]
	...
	public partial class Users
	{
		...
		[Column("password"), NotNull              ] public string Password { get; set; } // character varying(100)
		[Column("phone"),    NotNull              ] public string Phone    { get; set; } // character varying(15)
		[Column("is_admin"),    Nullable          ] public bool?  IsAdmin  { get; set; } // boolean

		#region Associations

		/// <summary>
		/// card_user_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Card> Carduseridfkeys { get; set; }
	...
	public static partial class SqlFunctions
	{
		...
		public static string Abbrev(ValueTuple<IPAddress, int>? par4)
		{
		...
		public static TimeSpan? Age(DateTime? par81)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? Avg<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, TimeSpan?>> par307)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Broadcast(IPAddress par706)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? Cidr(IPAddress par996)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? CidrIn(object par1000)
		{
			throw new InvalidOperationException();
		}
		...
		public static object CidrOut(ValueTuple<IPAddress, int>? par1002)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? CidrRecv(object par1004)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] CidrSend(ValueTuple<IPAddress, int>? par1006)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? Date(DateTime? par1215)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? DateCmp(DateTime? par1217, DateTime? par1218)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? DateCmpTimestamp(DateTime? par1220, DateTime? par1221)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? DateCmpTimestamptz(DateTime? par1223, DateTimeOffset? par1224)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateEq(DateTime? par1226, DateTime? par1227)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateEqTimestamp(DateTime? par1229, DateTime? par1230)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateEqTimestamptz(DateTime? par1232, DateTimeOffset? par1233)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGe(DateTime? par1235, DateTime? par1236)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGeTimestamp(DateTime? par1238, DateTime? par1239)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGeTimestamptz(DateTime? par1241, DateTimeOffset? par1242)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGt(DateTime? par1244, DateTime? par1245)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGtTimestamp(DateTime? par1247, DateTime? par1248)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateGtTimestamptz(DateTime? par1250, DateTimeOffset? par1251)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateIn(object par1253)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateLarger(DateTime? par1255, DateTime? par1256)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLe(DateTime? par1258, DateTime? par1259)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLeTimestamp(DateTime? par1261, DateTime? par1262)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLeTimestamptz(DateTime? par1264, DateTimeOffset? par1265)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLt(DateTime? par1267, DateTime? par1268)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLtTimestamp(DateTime? par1270, DateTime? par1271)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateLtTimestamptz(DateTime? par1273, DateTimeOffset? par1274)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? DateMi(DateTime? par1276, DateTime? par1277)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateMii(DateTime? par1279, int? par1280)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateMiInterval(DateTime? par1282, TimeSpan? par1283)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateNe(DateTime? par1285, DateTime? par1286)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateNeTimestamp(DateTime? par1288, DateTime? par1289)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? DateNeTimestamptz(DateTime? par1291, DateTimeOffset? par1292)
		{
			throw new InvalidOperationException();
		}
		...
		public static object DateOut(DateTime? par1294)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DatePli(DateTime? par1320, int? par1321)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DatePlInterval(DateTime? par1323, TimeSpan? par1324)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Daterange(DateTime? par1329, DateTime? par1330, string par1331)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? DaterangeSubdiff(DateTime? par1335, DateTime? par1336)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateRecv(object par1338)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] DateSend(DateTime? par1340)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DateSmaller(DateTime? par1342, DateTime? par1343)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? DatetimePl(DateTime? par1346, TimeSpan? par1347)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? DatetimetzPl(DateTime? par1349, DateTimeOffset? par1350)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Family(IPAddress par1603)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Hashinet(IPAddress par2371)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Host(IPAddress par2553)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Hostmask(IPAddress par2555)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Inetand(IPAddress par2605, IPAddress par2606)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetClientAddr()
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? InetGistConsistent(object par2612, IPAddress par2613, short? par2614, int? par2615, object par2616)
		{
			throw new InvalidOperationException();
		}
		...
		public static object InetGistSame(IPAddress par2629, IPAddress par2630, object par2631)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetGistUnion(object par2633, object par2634)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetIn(object par2636)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? InetMerge(IPAddress par2638, IPAddress par2639)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? Inetmi(IPAddress par2641, IPAddress par2642)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetmiInt8(IPAddress par2644, long? par2645)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Inetnot(IPAddress par2647)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Inetor(IPAddress par2649, IPAddress par2650)
		{
			throw new InvalidOperationException();
		}
		...
		public static object InetOut(IPAddress par2652)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Inetpl(IPAddress par2654, long? par2655)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetRecv(object par2657)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? InetSameFamily(IPAddress par2659, IPAddress par2660)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] InetSend(IPAddress par2662)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress InetServerAddr()
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Int8plInet(long? par3191, IPAddress par3192)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? IntegerPlDate(int? par3229, DateTime? par3230)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? Interval(TimeSpan? par3250)
		{
			throw new InvalidOperationException();
		}
		...
		public static object IntervalAccum(object par3252, TimeSpan? par3253)
		{
			throw new InvalidOperationException();
		}
		...
		public static object IntervalAccumInv(object par3255, TimeSpan? par3256)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalAvg(object par3258)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? IntervalCmp(TimeSpan? par3260, TimeSpan? par3261)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalDiv(TimeSpan? par3266, double? par3267)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalEq(TimeSpan? par3269, TimeSpan? par3270)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalGe(TimeSpan? par3272, TimeSpan? par3273)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalGt(TimeSpan? par3275, TimeSpan? par3276)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? IntervalHash(TimeSpan? par3278)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalIn(object par3280, int? par3281, int? par3282)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalLarger(TimeSpan? par3284, TimeSpan? par3285)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalLe(TimeSpan? par3287, TimeSpan? par3288)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalLt(TimeSpan? par3290, TimeSpan? par3291)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalMi(TimeSpan? par3293, TimeSpan? par3294)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalMul(TimeSpan? par3296, double? par3297)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? IntervalNe(TimeSpan? par3299, TimeSpan? par3300)
		{
			throw new InvalidOperationException();
		}
		...
		public static object IntervalOut(TimeSpan? par3302)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalPl(TimeSpan? par3304, TimeSpan? par3305)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? IntervalPlDate(TimeSpan? par3307, DateTime? par3308)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalPlTime(TimeSpan? par3310, TimeSpan? par3311)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? IntervalPlTimestamp(TimeSpan? par3313, DateTime? par3314)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? IntervalPlTimestamptz(TimeSpan? par3316, DateTimeOffset? par3317)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? IntervalPlTimetz(TimeSpan? par3319, DateTimeOffset? par3320)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalRecv(object par3322, int? par3323, int? par3324)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] IntervalSend(TimeSpan? par3326)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalSmaller(TimeSpan? par3328, TimeSpan? par3329)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? IntervalUm(TimeSpan? par3337)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? JustifyDays(TimeSpan? par3580)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? JustifyHours(TimeSpan? par3582)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? JustifyInterval(TimeSpan? par3584)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? MakeInterval(int? years, int? months, int? weeks, int? days, int? hours, int? mins, double? secs)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Masklen(IPAddress par3977)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Max<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, IPAddress>> par4019)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Min<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, IPAddress>> par4145)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? MulDInterval(double? par4173, TimeSpan? par4174)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress Netmask(IPAddress par4245)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? Network(IPAddress par4247)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? NetworkCmp(IPAddress par4249, IPAddress par4250)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkEq(IPAddress par4252, IPAddress par4253)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkGe(IPAddress par4255, IPAddress par4256)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkGt(IPAddress par4258, IPAddress par4259)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress NetworkLarger(IPAddress par4267, IPAddress par4268)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkLe(IPAddress par4270, IPAddress par4271)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkLt(IPAddress par4273, IPAddress par4274)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkNe(IPAddress par4276, IPAddress par4277)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkOverlap(IPAddress par4279, IPAddress par4280)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress NetworkSmaller(IPAddress par4287, IPAddress par4288)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkSub(IPAddress par4290, IPAddress par4291)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkSubeq(IPAddress par4293, IPAddress par4294)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkSup(IPAddress par4296, IPAddress par4297)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? NetworkSupeq(IPAddress par4299, IPAddress par4300)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Overlaps(DateTime? par4671, TimeSpan? par4672, DateTime? par4673, DateTime? par4674)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PercentileCont<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, object>> par4770, Expression<Func<TSource, TimeSpan?>> par4771)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? PercentileContIntervalFinal(object par4779, double? par4780)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgDatabaseSize(int? par4858)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDdlCommandIn(object par4861)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDdlCommandOut(object par4863)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDdlCommandRecv(object par4865)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgDdlCommandSend(object par4867)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDependenciesIn(object par4869)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDependenciesOut(object par4871)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDependenciesRecv(object par4873)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgDependenciesSend(object par4875)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgDescribeObject(int? par4877, int? par4878, int? par4879)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgDropReplicationSlot(string par4880)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgEncodingMaxLength(int? par4882)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgEncodingToChar(int? par4884)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgExtensionConfigDump(object par4888, string par4889)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgFilenodeRelation(int? par4891, int? par4892)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgFunctionIsVisible(int? par4894)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetConstraintdef(int? par4898, bool? par4899)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetExpr(object par4904, int? par4905, bool? par4906)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetFunctionArgDefault(int? par4908, int? par4909)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetFunctionArguments(int? par4911)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetFunctiondef(int? par4913)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetFunctionIdentityArguments(int? par4915)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetFunctionResult(int? par4917)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetIndexdef(int? par4921, int? par4922, bool? par4923)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetPartitionConstraintdef(int? par4925)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetPartkeydef(int? par4927)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgGetReplicaIdentityIndex(object par4929)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetRuledef(int? par4933, bool? par4934)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetSerialSequence(string par4936, string par4937)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetStatisticsobjdef(int? par4939)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetTriggerdef(int? par4943, bool? par4944)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetUserbyid(int? par4946)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgGetViewdef(int? par4958, int? par4959)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgHasRole(int? par4980, string par4981)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgImportSystemCollations(object par4983)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgIndexamHasProperty(int? par4985, string par4986)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgIndexColumnHasProperty(object par4988, int? par4989, string par4990)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgIndexesSize(object par4992)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgIndexHasProperty(object par4994, string par4995)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgIndexPosition(int? par4997, short? par4998)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgIsolationTestSessionIsBlocked(int? par5003, object par5004)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgIsOtherTempSchema(int? par5006)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgKeysequal(object par5009, object par5010)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgLogicalEmitMessage(bool? par5019, string par5020, byte[] par5021)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgLsnCmp(object par5027, object par5028)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnEq(object par5030, object par5031)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnGe(object par5033, object par5034)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnGt(object par5036, object par5037)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgLsnHash(object par5039)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgLsnIn(object par5041)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnLe(object par5043, object par5044)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnLt(object par5046, object par5047)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? PgLsnMi(object par5049, object par5050)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgLsnNe(object par5052, object par5053)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgLsnOut(object par5055)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgLsnRecv(object par5057)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgLsnSend(object par5059)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNdistinctIn(object par5062)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNdistinctOut(object par5064)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNdistinctRecv(object par5066)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgNdistinctSend(object par5068)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNodeTreeIn(object par5070)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNodeTreeOut(object par5072)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNodeTreeRecv(object par5074)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgNodeTreeSend(object par5076)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgNotify(string par5078, string par5079)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgOpclassIsVisible(int? par5084)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgOperatorIsVisible(int? par5086)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgOpfamilyIsVisible(int? par5088)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PgReadBinaryFile(string par5100)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgReadFile(string par5111)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgRelationFilenode(object par5113)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgRelationFilepath(object par5115)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgRelationIsPublishable(object par5117)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgRelationIsUpdatable(object par5119, bool? par5120)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgRelationSize(object par5124, string par5125)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginAdvance(string par5126, object par5127)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgReplicationOriginCreate(string par5129)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginDrop(string par5130)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgReplicationOriginOid(string par5132)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginProgress(string par5134, bool? par5135)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginSessionProgress(bool? par5138)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginSessionSetup(string par5139)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgReplicationOriginXactSetup(object par5140, DateTimeOffset? par5141)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgSafeSnapshotBlockingPids(int? par5143)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgSequenceLastValue(object par5145)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgSizeBytes(string par5147)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgSleepFor(TimeSpan? par5153)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgSleepUntil(DateTimeOffset? par5154)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetAnalyzeCount(int? par5156)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetAutoanalyzeCount(int? par5158)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetAutovacuumCount(int? par5160)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgStatGetBackendActivity(int? par5162)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetBackendActivityStart(int? par5164)
		{
			throw new InvalidOperationException();
		}
		...
		public static IPAddress PgStatGetBackendClientAddr(int? par5166)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgStatGetBackendClientPort(int? par5168)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgStatGetBackendDbid(int? par5170)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgStatGetBackendPid(int? par5172)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetBackendStart(int? par5174)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgStatGetBackendUserid(int? par5176)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgStatGetBackendWaitEvent(int? par5178)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgStatGetBackendWaitEventType(int? par5180)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetBackendXactStart(int? par5182)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetBlocksFetched(int? par5190)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetBlocksHit(int? par5192)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetDbBlkReadTime(int? par5199)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetDbBlkWriteTime(int? par5201)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbBlocksFetched(int? par5203)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbBlocksHit(int? par5205)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictAll(int? par5207)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictBufferpin(int? par5209)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictLock(int? par5211)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictSnapshot(int? par5213)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictStartupDeadlock(int? par5215)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbConflictTablespace(int? par5217)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbDeadlocks(int? par5219)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgStatGetDbNumbackends(int? par5221)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetDbStatResetTime(int? par5223)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTempBytes(int? par5225)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTempFiles(int? par5227)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTuplesDeleted(int? par5229)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTuplesFetched(int? par5231)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTuplesInserted(int? par5233)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTuplesReturned(int? par5235)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbTuplesUpdated(int? par5237)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbXactCommit(int? par5239)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDbXactRollback(int? par5241)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetDeadTuples(int? par5243)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetFunctionCalls(int? par5245)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetFunctionSelfTime(int? par5247)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetFunctionTotalTime(int? par5249)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetLastAnalyzeTime(int? par5251)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetLastAutoanalyzeTime(int? par5253)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetLastAutovacuumTime(int? par5255)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgStatGetLastVacuumTime(int? par5257)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetLiveTuples(int? par5259)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetModSinceAnalyze(int? par5261)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetNumscans(int? par5263)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesDeleted(int? par5266)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesFetched(int? par5268)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesHotUpdated(int? par5270)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesInserted(int? par5272)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesReturned(int? par5274)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetTuplesUpdated(int? par5276)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetVacuumCount(int? par5278)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactBlocksFetched(int? par5280)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactBlocksHit(int? par5282)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactFunctionCalls(int? par5284)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetXactFunctionSelfTime(int? par5286)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PgStatGetXactFunctionTotalTime(int? par5288)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactNumscans(int? par5290)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesDeleted(int? par5292)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesFetched(int? par5294)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesHotUpdated(int? par5296)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesInserted(int? par5298)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesReturned(int? par5300)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgStatGetXactTuplesUpdated(int? par5302)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgStatisticsObjIsVisible(int? par5304)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTableIsVisible(int? par5306)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgTableSize(object par5308)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgTablespaceLocation(int? par5311)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgTablespaceSize(string par5315)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTerminateBackend(int? par5317)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? PgTotalRelationSize(object par5319)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgTruetypid(object par5322, object par5323)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PgTruetypmod(object par5325, object par5326)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTryAdvisoryLock(int? par5330, int? par5331)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTryAdvisoryLockShared(int? par5335, int? par5336)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTryAdvisoryXactLock(int? par5340, int? par5341)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTryAdvisoryXactLockShared(int? par5345, int? par5346)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTsConfigIsVisible(int? par5348)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTsDictIsVisible(int? par5350)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTsParserIsVisible(int? par5352)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTsTemplateIsVisible(int? par5354)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PgTypeIsVisible(int? par5356)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PgTypeof(object par5358)
		{
			throw new InvalidOperationException();
		}
		...
		public static string PgWalfileName(object par5360)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? PgWalLsnDiff(object par5362, object par5363)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? PgXactCommitTimestamp(int? par5365)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PhrasetoTsquery(object par5369, string par5370)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PlaintoTsquery(string par5376)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PlpgsqlInlineHandler(object par5378)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PlpgsqlValidator(int? par5379)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? Point(NpgsqlPolygon? par5392)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointAbove(NpgsqlPoint? par5394, NpgsqlPoint? par5395)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointAdd(NpgsqlPoint? par5397, NpgsqlPoint? par5398)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointBelow(NpgsqlPoint? par5400, NpgsqlPoint? par5401)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PointDistance(NpgsqlPoint? par5403, NpgsqlPoint? par5404)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointDiv(NpgsqlPoint? par5406, NpgsqlPoint? par5407)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointEq(NpgsqlPoint? par5409, NpgsqlPoint? par5410)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointHoriz(NpgsqlPoint? par5412, NpgsqlPoint? par5413)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointIn(object par5415)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointLeft(NpgsqlPoint? par5417, NpgsqlPoint? par5418)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointMul(NpgsqlPoint? par5420, NpgsqlPoint? par5421)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointNe(NpgsqlPoint? par5423, NpgsqlPoint? par5424)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PointOut(NpgsqlPoint? par5426)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointRecv(object par5428)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointRight(NpgsqlPoint? par5430, NpgsqlPoint? par5431)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PointSend(NpgsqlPoint? par5433)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PointSub(NpgsqlPoint? par5435, NpgsqlPoint? par5436)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PointVert(NpgsqlPoint? par5438, NpgsqlPoint? par5439)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyAbove(NpgsqlPolygon? par5441, NpgsqlPolygon? par5442)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyBelow(NpgsqlPolygon? par5444, NpgsqlPolygon? par5445)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPoint? PolyCenter(NpgsqlPolygon? par5447)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyContain(NpgsqlPolygon? par5449, NpgsqlPolygon? par5450)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyContained(NpgsqlPolygon? par5452, NpgsqlPolygon? par5453)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyContainPt(NpgsqlPolygon? par5455, NpgsqlPoint? par5456)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? PolyDistance(NpgsqlPolygon? par5458, NpgsqlPolygon? par5459)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPolygon? Polygon(NpgsqlCircle? par5468)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPolygon? PolyIn(object par5470)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyLeft(NpgsqlPolygon? par5472, NpgsqlPolygon? par5473)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? PolyNpoints(NpgsqlPolygon? par5475)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PolyOut(NpgsqlPolygon? par5477)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyOverabove(NpgsqlPolygon? par5479, NpgsqlPolygon? par5480)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyOverbelow(NpgsqlPolygon? par5482, NpgsqlPolygon? par5483)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyOverlap(NpgsqlPolygon? par5485, NpgsqlPolygon? par5486)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyOverleft(NpgsqlPolygon? par5488, NpgsqlPolygon? par5489)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyOverright(NpgsqlPolygon? par5491, NpgsqlPolygon? par5492)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPolygon? PolyRecv(object par5494)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolyRight(NpgsqlPolygon? par5496, NpgsqlPolygon? par5497)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PolySame(NpgsqlPolygon? par5499, NpgsqlPolygon? par5500)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] PolySend(NpgsqlPolygon? par5502)
		{
			throw new InvalidOperationException();
		}
		...
		public static NpgsqlPath? Popen(NpgsqlPath? par5504)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Position(string par5512, string par5513)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Positionjoinsel(object par5515, int? par5516, object par5517, short? par5518, object par5519)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Positionsel(object par5521, int? par5522, object par5523, int? par5524)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PostgresqlFdwValidator(object par5526, int? par5527)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Pow(decimal? par5532, decimal? par5533)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Power(decimal? par5538, decimal? par5539)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PrsdEnd(object par5540)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PrsdHeadline(object par5542, object par5543, object par5544)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PrsdLextype(object par5546)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PrsdNexttoken(object par5548, object par5549, object par5550)
		{
			throw new InvalidOperationException();
		}
		...
		public static object PrsdStart(object par5552, int? par5553)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PtContainedCircle(NpgsqlPoint? par5555, NpgsqlCircle? par5556)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? PtContainedPoly(NpgsqlPoint? par5558, NpgsqlPolygon? par5559)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Querytree(object par5564)
		{
			throw new InvalidOperationException();
		}
		...
		public static string QuoteIdent(string par5566)
		{
			throw new InvalidOperationException();
		}
		...
		public static string QuoteLiteral(object par5570)
		{
			throw new InvalidOperationException();
		}
		...
		public static string QuoteNullable(object par5574)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Radians(double? par5576)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Radius(NpgsqlCircle? par5578)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeAdjacent(object par5581, object par5582)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeAfter(object par5584, object par5585)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeBefore(object par5587, object par5588)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? RangeCmp(object par5590, object par5591)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeContainedBy(object par5593, object par5594)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeContains(object par5596, object par5597)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeContainsElem(object par5599, object par5600)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeEq(object par5602, object par5603)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeGe(object par5605, object par5606)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistCompress(object par5608)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeGistConsistent(object par5610, object par5611, short? par5612, int? par5613, object par5614)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistDecompress(object par5616)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistFetch(object par5618)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistPenalty(object par5620, object par5621, object par5622)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistPicksplit(object par5624, object par5625)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistSame(object par5627, object par5628, object par5629)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeGistUnion(object par5631, object par5632)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeGt(object par5634, object par5635)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeIn(object par5637, int? par5638, int? par5639)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeIntersect(object par5641, object par5642)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeLe(object par5644, object par5645)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeLt(object par5647, object par5648)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeMerge(object par5650, object par5651)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeMinus(object par5653, object par5654)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeNe(object par5656, object par5657)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeOut(object par5659)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeOverlaps(object par5661, object par5662)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeOverleft(object par5664, object par5665)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeOverright(object par5667, object par5668)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeRecv(object par5670, int? par5671, int? par5672)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Rangesel(object par5674, int? par5675, object par5676, int? par5677)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] RangeSend(object par5679)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RangeTypanalyze(object par5681)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RangeUnion(object par5683, object par5684)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? Rank<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, object>> par5687)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? RankFinal(object par5689, object par5690)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordEq(object par5692, object par5693)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordGe(object par5695, object par5696)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordGt(object par5698, object par5699)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageEq(object par5701, object par5702)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageGe(object par5704, object par5705)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageGt(object par5707, object par5708)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageLe(object par5710, object par5711)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageLt(object par5713, object par5714)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordImageNe(object par5716, object par5717)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RecordIn(object par5718, int? par5719, int? par5720)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordLe(object par5722, object par5723)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordLt(object par5725, object par5726)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RecordNe(object par5728, object par5729)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RecordOut(object par5731)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RecordRecv(object par5732, int? par5733, int? par5734)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] RecordSend(object par5736)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regclass(string par5738)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regclassin(object par5740)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regclassout(object par5742)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regclassrecv(object par5744)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regclasssend(object par5746)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regconfigin(object par5748)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regconfigout(object par5750)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regconfigrecv(object par5752)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regconfigsend(object par5754)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regdictionaryin(object par5756)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regdictionaryout(object par5758)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regdictionaryrecv(object par5760)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regdictionarysend(object par5762)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Regexeqjoinsel(object par5764, int? par5765, object par5766, short? par5767, object par5768)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Regexeqsel(object par5770, int? par5771, object par5772, int? par5773)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Regexnejoinsel(object par5775, int? par5776, object par5777, short? par5778, object par5779)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Regexnesel(object par5781, int? par5782, object par5783, int? par5784)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RegexpMatch(string par5789, string par5790, string par5791)
		{
			throw new InvalidOperationException();
		}
		...
		public static string RegexpReplace(string par5802, string par5803, string par5804, string par5805)
		{
			throw new InvalidOperationException();
		}
		...
		public static object RegexpSplitToArray(string par5810, string par5811, string par5812)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regnamespacein(object par5819)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regnamespaceout(object par5821)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regnamespacerecv(object par5823)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regnamespacesend(object par5825)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperatorin(object par5827)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperatorout(object par5829)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperatorrecv(object par5831)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regoperatorsend(object par5833)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperin(object par5835)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperout(object par5837)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regoperrecv(object par5839)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regopersend(object par5841)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocedurein(object par5843)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocedureout(object par5845)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocedurerecv(object par5847)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regproceduresend(object par5849)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocin(object par5851)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocout(object par5853)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regprocrecv(object par5855)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regprocsend(object par5857)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrAvgx<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5859, Expression<Func<TSource, double?>> par5860)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrAvgy<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5862, Expression<Func<TSource, double?>> par5863)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? RegrCount<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5865, Expression<Func<TSource, double?>> par5866)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrIntercept<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5868, Expression<Func<TSource, double?>> par5869)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regrolein(object par5871)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regroleout(object par5873)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regrolerecv(object par5875)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regrolesend(object par5877)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrR2<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5879, Expression<Func<TSource, double?>> par5880)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrSlope<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5882, Expression<Func<TSource, double?>> par5883)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrSxx<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5885, Expression<Func<TSource, double?>> par5886)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrSxy<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5888, Expression<Func<TSource, double?>> par5889)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? RegrSyy<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, double?>> par5891, Expression<Func<TSource, double?>> par5892)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regtypein(object par5894)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regtypeout(object par5896)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Regtyperecv(object par5898)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Regtypesend(object par5900)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Reltime(TimeSpan? par5902)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimeeq(object par5904, object par5905)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimege(object par5907, object par5908)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimegt(object par5910, object par5911)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Reltimein(object par5913)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimele(object par5915, object par5916)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimelt(object par5918, object par5919)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Reltimene(object par5921, object par5922)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Reltimeout(object par5924)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Reltimerecv(object par5926)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Reltimesend(object par5928)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Repeat(string par5930, int? par5931)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Replace(string par5933, string par5934, string par5935)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Reverse(string par5937)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Right(string par5951, int? par5952)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Round(decimal? par5959)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? RowSecurityActive(string par5964)
		{
			throw new InvalidOperationException();
		}
		...
		public static string RowToJson(object par5968, bool? par5969)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Rpad(string par5975, int? par5976)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Rtrim(string par5981)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Scalargtjoinsel(object par5983, int? par5984, object par5985, short? par5986, object par5987)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Scalargtsel(object par5989, int? par5990, object par5991, int? par5992)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Scalarltjoinsel(object par5994, int? par5995, object par5996, short? par5997, object par5998)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Scalarltsel(object par6000, int? par6001, object par6002, int? par6003)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Scale(decimal? par6005)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] SetBit(byte[] par6015, int? par6016, int? par6017)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] SetByte(byte[] par6019, int? par6020, int? par6021)
		{
			throw new InvalidOperationException();
		}
		...
		public static string SetConfig(string par6023, string par6024, bool? par6025)
		{
			throw new InvalidOperationException();
		}
		...
		public static ValueTuple<IPAddress, int>? SetMasklen(ValueTuple<IPAddress, int>? par6030, int? par6031)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Setseed(double? par6032)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? Setval(object par6037, long? par6038, bool? par6039)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Setweight(object par6045, object par6046)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ShellIn(object par6048)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ShellOut(object par6050)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ShiftJis2004ToEucJis2004(int? par6051, int? par6052, object par6053, object par6054, int? par6055)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ShiftJis2004ToUtf8(int? par6056, int? par6057, object par6058, object par6059, int? par6060)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ShobjDescription(int? par6062, string par6063)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Sign(double? par6067)
		{
			throw new InvalidOperationException();
		}
		...
		public static string SimilarEscape(string par6069, string par6070)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Sin(double? par6072)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Sind(double? par6074)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SjisToEucJp(int? par6075, int? par6076, object par6077, object par6078, int? par6079)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SjisToMic(int? par6080, int? par6081, object par6082, object par6083, int? par6084)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SjisToUtf8(int? par6085, int? par6086, object par6087, object par6088, int? par6089)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Slope(NpgsqlPoint? par6091, NpgsqlPoint? par6092)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Smgreq(object par6094, object par6095)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Smgrin(object par6097)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Smgrne(object par6099, object par6100)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Smgrout(object par6102)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgBoxQuadChoose(object par6103, object par6104)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgBoxQuadConfig(object par6105, object par6106)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgBoxQuadInnerConsistent(object par6107, object par6108)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? SpgBoxQuadLeafConsistent(object par6110, object par6111)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgBoxQuadPicksplit(object par6112, object par6113)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Spghandler(object par6115)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgKdChoose(object par6116, object par6117)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgKdConfig(object par6118, object par6119)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgKdInnerConsistent(object par6120, object par6121)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgKdPicksplit(object par6122, object par6123)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgQuadChoose(object par6124, object par6125)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgQuadConfig(object par6126, object par6127)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgQuadInnerConsistent(object par6128, object par6129)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? SpgQuadLeafConsistent(object par6131, object par6132)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgQuadPicksplit(object par6133, object par6134)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgRangeQuadChoose(object par6135, object par6136)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgRangeQuadConfig(object par6137, object par6138)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgRangeQuadInnerConsistent(object par6139, object par6140)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? SpgRangeQuadLeafConsistent(object par6142, object par6143)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgRangeQuadPicksplit(object par6144, object par6145)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgTextChoose(object par6146, object par6147)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgTextConfig(object par6148, object par6149)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgTextInnerConsistent(object par6150, object par6151)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? SpgTextLeafConsistent(object par6153, object par6154)
		{
			throw new InvalidOperationException();
		}
		...
		public static object SpgTextPicksplit(object par6155, object par6156)
		{
			throw new InvalidOperationException();
		}
		...
		public static string SplitPart(string par6158, string par6159, int? par6160)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Sqrt(decimal? par6164)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Stddev<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par6177)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? StddevPop<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par6189)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? StddevSamp<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par6201)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] StringAgg<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, byte[]>> par6206, Expression<Func<TSource, byte[]>> par6207)
		{
			throw new InvalidOperationException();
		}
		...
		public static string StringAggFinalfn(object par6209)
		{
			throw new InvalidOperationException();
		}
		...
		public static object StringAggTransfn(object par6211, string par6212, string par6213)
		{
			throw new InvalidOperationException();
		}
		...
		public static object StringToArray(string par6219, string par6220)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Strip(object par6222)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Strpos(string par6224, string par6225)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Substr(string par6238, int? par6239)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Substring(string par6266, int? par6267)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Sum<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par6283)
		{
			throw new InvalidOperationException();
		}
		...
		public static object System(object par6286)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Tan(double? par6291)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Tand(double? par6293)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Text(object par6305)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Textanycat(string par6307, object par6308)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Textcat(string par6310, string par6311)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Texteq(string par6313, string par6314)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextGe(string par6316, string par6317)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextGt(string par6319, string par6320)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Texticlike(string par6322, string par6323)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Texticnlike(string par6325, string par6326)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Texticregexeq(string par6328, string par6329)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Texticregexne(string par6331, string par6332)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Textin(object par6334)
		{
			throw new InvalidOperationException();
		}
		...
		public static string TextLarger(string par6336, string par6337)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextLe(string par6339, string par6340)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Textlen(string par6342)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Textlike(string par6344, string par6345)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextLt(string par6347, string par6348)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Textne(string par6350, string par6351)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Textnlike(string par6353, string par6354)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Textout(string par6356)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextPatternGe(string par6358, string par6359)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextPatternGt(string par6361, string par6362)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextPatternLe(string par6364, string par6365)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TextPatternLt(string par6367, string par6368)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Textrecv(object par6370)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Textregexeq(string par6372, string par6373)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Textregexne(string par6375, string par6376)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Textsend(string par6378)
		{
			throw new InvalidOperationException();
		}
		...
		public static string TextSmaller(string par6380, string par6381)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ThesaurusInit(object par6383)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ThesaurusLexize(object par6385, object par6386, object par6387, object par6388)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tideq(object par6390, object par6391)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tidge(object par6393, object par6394)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tidgt(object par6396, object par6397)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tidin(object par6399)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tidlarger(object par6401, object par6402)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tidle(object par6404, object par6405)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tidlt(object par6407, object par6408)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tidne(object par6410, object par6411)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tidout(object par6413)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tidrecv(object par6415)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Tidsend(object par6417)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tidsmaller(object par6419, object par6420)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? Time(DateTimeOffset? par6433)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimeCmp(TimeSpan? par6435, TimeSpan? par6436)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimedatePl(TimeSpan? par6438, DateTime? par6439)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeEq(TimeSpan? par6441, TimeSpan? par6442)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeGe(TimeSpan? par6444, TimeSpan? par6445)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeGt(TimeSpan? par6447, TimeSpan? par6448)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimeHash(TimeSpan? par6450)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeIn(object par6452, int? par6453, int? par6454)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeLarger(TimeSpan? par6456, TimeSpan? par6457)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeLe(TimeSpan? par6459, TimeSpan? par6460)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeLt(TimeSpan? par6462, TimeSpan? par6463)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timemi(object par6465, object par6466)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeMiInterval(TimeSpan? par6468, TimeSpan? par6469)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeMiTime(TimeSpan? par6471, TimeSpan? par6472)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimeNe(TimeSpan? par6474, TimeSpan? par6475)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimeOut(TimeSpan? par6479)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timepl(object par6481, object par6482)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimePlInterval(TimeSpan? par6484, TimeSpan? par6485)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeRecv(object par6487, int? par6488, int? par6489)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] TimeSend(TimeSpan? par6491)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimeSmaller(TimeSpan? par6493, TimeSpan? par6494)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? Timestamp(DateTimeOffset? par6506)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestampCmp(DateTime? par6508, DateTime? par6509)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestampCmpDate(DateTime? par6511, DateTime? par6512)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestampCmpTimestamptz(DateTime? par6514, DateTimeOffset? par6515)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampEq(DateTime? par6517, DateTime? par6518)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampEqDate(DateTime? par6520, DateTime? par6521)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampEqTimestamptz(DateTime? par6523, DateTimeOffset? par6524)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGe(DateTime? par6526, DateTime? par6527)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGeDate(DateTime? par6529, DateTime? par6530)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGeTimestamptz(DateTime? par6532, DateTimeOffset? par6533)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGt(DateTime? par6535, DateTime? par6536)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGtDate(DateTime? par6538, DateTime? par6539)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampGtTimestamptz(DateTime? par6541, DateTimeOffset? par6542)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestampHash(DateTime? par6544)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampIn(object par6546, int? par6547, int? par6548)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestampIzoneTransform(object par6550)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampLarger(DateTime? par6552, DateTime? par6553)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLe(DateTime? par6555, DateTime? par6556)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLeDate(DateTime? par6558, DateTime? par6559)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLeTimestamptz(DateTime? par6561, DateTimeOffset? par6562)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLt(DateTime? par6564, DateTime? par6565)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLtDate(DateTime? par6567, DateTime? par6568)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampLtTimestamptz(DateTime? par6570, DateTimeOffset? par6571)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimestampMi(DateTime? par6573, DateTime? par6574)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampMiInterval(DateTime? par6576, TimeSpan? par6577)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampNe(DateTime? par6579, DateTime? par6580)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampNeDate(DateTime? par6582, DateTime? par6583)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestampNeTimestamptz(DateTime? par6585, DateTimeOffset? par6586)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestampOut(DateTime? par6588)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampPlInterval(DateTime? par6590, TimeSpan? par6591)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampRecv(object par6593, int? par6594, int? par6595)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] TimestampSend(DateTime? par6597)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? TimestampSmaller(DateTime? par6599, DateTime? par6600)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestampSortsupport(object par6601)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestampTransform(object par6603)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Timestamptypmodin(object par6605)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timestamptypmodout(int? par6607)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? Timestamptz(DateTime? par6622)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestamptzCmp(DateTimeOffset? par6624, DateTimeOffset? par6625)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestamptzCmpDate(DateTimeOffset? par6627, DateTime? par6628)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimestamptzCmpTimestamp(DateTimeOffset? par6630, DateTime? par6631)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzEq(DateTimeOffset? par6633, DateTimeOffset? par6634)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzEqDate(DateTimeOffset? par6636, DateTime? par6637)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzEqTimestamp(DateTimeOffset? par6639, DateTime? par6640)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGe(DateTimeOffset? par6642, DateTimeOffset? par6643)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGeDate(DateTimeOffset? par6645, DateTime? par6646)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGeTimestamp(DateTimeOffset? par6648, DateTime? par6649)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGt(DateTimeOffset? par6651, DateTimeOffset? par6652)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGtDate(DateTimeOffset? par6654, DateTime? par6655)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzGtTimestamp(DateTimeOffset? par6657, DateTime? par6658)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzIn(object par6660, int? par6661, int? par6662)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzLarger(DateTimeOffset? par6664, DateTimeOffset? par6665)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLe(DateTimeOffset? par6667, DateTimeOffset? par6668)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLeDate(DateTimeOffset? par6670, DateTime? par6671)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLeTimestamp(DateTimeOffset? par6673, DateTime? par6674)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLt(DateTimeOffset? par6676, DateTimeOffset? par6677)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLtDate(DateTimeOffset? par6679, DateTime? par6680)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzLtTimestamp(DateTimeOffset? par6682, DateTime? par6683)
		{
			throw new InvalidOperationException();
		}
		...
		public static TimeSpan? TimestamptzMi(DateTimeOffset? par6685, DateTimeOffset? par6686)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzMiInterval(DateTimeOffset? par6688, TimeSpan? par6689)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzNe(DateTimeOffset? par6691, DateTimeOffset? par6692)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzNeDate(DateTimeOffset? par6694, DateTime? par6695)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimestamptzNeTimestamp(DateTimeOffset? par6697, DateTime? par6698)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestamptzOut(DateTimeOffset? par6700)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzPlInterval(DateTimeOffset? par6702, TimeSpan? par6703)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzRecv(object par6705, int? par6706, int? par6707)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] TimestamptzSend(DateTimeOffset? par6709)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimestamptzSmaller(DateTimeOffset? par6711, DateTimeOffset? par6712)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Timestamptztypmodin(object par6714)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timestamptztypmodout(int? par6716)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimestampZoneTransform(object par6718)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimeTransform(object par6720)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Timetypmodin(object par6722)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timetypmodout(int? par6724)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? Timetz(TimeSpan? par6731)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimetzCmp(DateTimeOffset? par6733, DateTimeOffset? par6734)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzdatePl(DateTimeOffset? par6736, DateTime? par6737)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzEq(DateTimeOffset? par6739, DateTimeOffset? par6740)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzGe(DateTimeOffset? par6742, DateTimeOffset? par6743)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzGt(DateTimeOffset? par6745, DateTimeOffset? par6746)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TimetzHash(DateTimeOffset? par6748)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzIn(object par6750, int? par6751, int? par6752)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzLarger(DateTimeOffset? par6754, DateTimeOffset? par6755)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzLe(DateTimeOffset? par6757, DateTimeOffset? par6758)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzLt(DateTimeOffset? par6760, DateTimeOffset? par6761)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzMiInterval(DateTimeOffset? par6763, TimeSpan? par6764)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TimetzNe(DateTimeOffset? par6766, DateTimeOffset? par6767)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TimetzOut(DateTimeOffset? par6769)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzPlInterval(DateTimeOffset? par6771, TimeSpan? par6772)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzRecv(object par6774, int? par6775, int? par6776)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] TimetzSend(DateTimeOffset? par6778)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? TimetzSmaller(DateTimeOffset? par6780, DateTimeOffset? par6781)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Timetztypmodin(object par6783)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Timetztypmodout(int? par6785)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? Timezone(TimeSpan? par6802, DateTime? par6803)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tinterval(object par6805, object par6806)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalct(object par6808, object par6809)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalend(object par6811)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervaleq(object par6813, object par6814)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalge(object par6816, object par6817)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalgt(object par6819, object par6820)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalin(object par6822)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalle(object par6824, object par6825)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalleneq(object par6827, object par6828)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallenge(object par6830, object par6831)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallengt(object par6833, object par6834)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallenle(object par6836, object par6837)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallenlt(object par6839, object par6840)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallenne(object par6842, object par6843)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervallt(object par6845, object par6846)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalne(object par6848, object par6849)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalout(object par6851)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalov(object par6853, object par6854)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalrecv(object par6856)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalrel(object par6858)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Tintervalsame(object par6860, object par6861)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Tintervalsend(object par6863)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tintervalstart(object par6865)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ToAscii(string par6872, string par6873)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ToChar(DateTime? par6896, string par6897)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTime? ToDate(string par6899, string par6900)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ToHex(long? par6904)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ToJson(object par6906)
		{
			throw new InvalidOperationException();
		}
		...
		public static string ToJsonb(object par6908)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? ToNumber(string par6910, string par6911)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegclass(string par6913)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegnamespace(string par6915)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegoper(string par6917)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegoperator(string par6919)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegproc(string par6921)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegprocedure(string par6923)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegrole(string par6925)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToRegtype(string par6927)
		{
			throw new InvalidOperationException();
		}
		...
		public static DateTimeOffset? ToTimestamp(string par6931, string par6932)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToTsquery(string par6937)
		{
			throw new InvalidOperationException();
		}
		...
		public static object ToTsvector(object par6951, string par6952)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Translate(string par6955, string par6956, string par6957)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TriggerIn(object par6959)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TriggerOut(object par6961)
		{
			throw new InvalidOperationException();
		}
		...
		public static PhysicalAddress Trunc(PhysicalAddress par6972)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsDelete(object par6977, object par6978)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsFilter(object par6980, object par6981)
		{
			throw new InvalidOperationException();
		}
		...
		public static string TsHeadline(string par7028, object par7029)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsLexize(object par7031, string par7032)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Tsmatchjoinsel(object par7034, int? par7035, object par7036, short? par7037, object par7038)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsMatchQv(object par7040, object par7041)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Tsmatchsel(object par7043, int? par7044, object par7045, int? par7046)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsMatchTq(string par7048, object par7049)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsMatchTt(string par7051, string par7052)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsMatchVq(object par7054, object par7055)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsmHandlerIn(object par7057)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsmHandlerOut(object par7059)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqMcontained(object par7061, object par7062)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqMcontains(object par7064, object par7065)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsqueryAnd(object par7067, object par7068)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TsqueryCmp(object par7070, object par7071)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryEq(object par7073, object par7074)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryGe(object par7076, object par7077)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryGt(object par7079, object par7080)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsqueryin(object par7082)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryLe(object par7084, object par7085)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryLt(object par7087, object par7088)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsqueryNe(object par7090, object par7091)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsqueryNot(object par7093)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsqueryOr(object par7095, object par7096)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsqueryout(object par7098)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsqueryPhrase(object par7103, object par7104, int? par7105)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsqueryrecv(object par7107)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Tsquerysend(object par7109)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsrange(DateTime? par7114, DateTime? par7115, string par7116)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? TsrangeSubdiff(DateTime? par7118, DateTime? par7119)
		{
			throw new InvalidOperationException();
		}
		...
		public static float? TsRank(object par7134, object par7135)
		{
			throw new InvalidOperationException();
		}
		...
		public static float? TsRankCd(object par7150, object par7151)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsRewrite(object par7157, string par7158)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsTypanalyze(object par7160)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tstzrange(DateTimeOffset? par7165, DateTimeOffset? par7166, string par7167)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? TstzrangeSubdiff(DateTimeOffset? par7169, DateTimeOffset? par7170)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? TsvectorCmp(object par7172, object par7173)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsvectorConcat(object par7175, object par7176)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorEq(object par7178, object par7179)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorGe(object par7181, object par7182)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorGt(object par7184, object par7185)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsvectorin(object par7187)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorLe(object par7189, object par7190)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorLt(object par7192, object par7193)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TsvectorNe(object par7195, object par7196)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsvectorout(object par7198)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Tsvectorrecv(object par7200)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Tsvectorsend(object par7202)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TsvectorToArray(object par7204)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TxidSnapshotIn(object par7211)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TxidSnapshotOut(object par7213)
		{
			throw new InvalidOperationException();
		}
		...
		public static object TxidSnapshotRecv(object par7215)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] TxidSnapshotSend(object par7217)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? TxidSnapshotXmax(object par7220)
		{
			throw new InvalidOperationException();
		}
		...
		public static long? TxidSnapshotXmin(object par7222)
		{
			throw new InvalidOperationException();
		}
		...
		public static string TxidStatus(long? par7224)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? TxidVisibleInSnapshot(long? par7226, object par7227)
		{
			throw new InvalidOperationException();
		}
		...
		public static object UhcToUtf8(int? par7228, int? par7229, object par7230, object par7231, int? par7232)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Unknownin(object par7235)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Unknownout(object par7237)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Unknownrecv(object par7239)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Unknownsend(object par7241)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Upper(string par7246)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UpperInc(object par7248)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UpperInf(object par7250)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToAscii(int? par7251, int? par7252, object par7253, object par7254, int? par7255)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToBig5(int? par7256, int? par7257, object par7258, object par7259, int? par7260)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToEucCn(int? par7261, int? par7262, object par7263, object par7264, int? par7265)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToEucJis2004(int? par7266, int? par7267, object par7268, object par7269, int? par7270)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToEucJp(int? par7271, int? par7272, object par7273, object par7274, int? par7275)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToEucKr(int? par7276, int? par7277, object par7278, object par7279, int? par7280)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToEucTw(int? par7281, int? par7282, object par7283, object par7284, int? par7285)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToGb18030(int? par7286, int? par7287, object par7288, object par7289, int? par7290)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToGbk(int? par7291, int? par7292, object par7293, object par7294, int? par7295)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToIso88591(int? par7296, int? par7297, object par7298, object par7299, int? par7300)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToIso8859(int? par7301, int? par7302, object par7303, object par7304, int? par7305)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToJohab(int? par7306, int? par7307, object par7308, object par7309, int? par7310)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToKoi8r(int? par7311, int? par7312, object par7313, object par7314, int? par7315)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToKoi8u(int? par7316, int? par7317, object par7318, object par7319, int? par7320)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToShiftJis2004(int? par7321, int? par7322, object par7323, object par7324, int? par7325)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToSjis(int? par7326, int? par7327, object par7328, object par7329, int? par7330)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToUhc(int? par7331, int? par7332, object par7333, object par7334, int? par7335)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Utf8ToWin(int? par7336, int? par7337, object par7338, object par7339, int? par7340)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? UuidCmp(Guid? par7342, Guid? par7343)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidEq(Guid? par7345, Guid? par7346)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidGe(Guid? par7348, Guid? par7349)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidGt(Guid? par7351, Guid? par7352)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? UuidHash(Guid? par7354)
		{
			throw new InvalidOperationException();
		}
		...
		public static Guid? UuidIn(object par7356)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidLe(Guid? par7358, Guid? par7359)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidLt(Guid? par7361, Guid? par7362)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? UuidNe(Guid? par7364, Guid? par7365)
		{
			throw new InvalidOperationException();
		}
		...
		public static object UuidOut(Guid? par7367)
		{
			throw new InvalidOperationException();
		}
		...
		public static Guid? UuidRecv(object par7369)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] UuidSend(Guid? par7371)
		{
			throw new InvalidOperationException();
		}
		...
		public static object UuidSortsupport(object par7372)
		{
			throw new InvalidOperationException();
		}
		...
		public static BitArray Varbit(BitArray par7374, int? par7375, bool? par7376)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Varbitcmp(BitArray par7378, BitArray par7379)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbiteq(BitArray par7381, BitArray par7382)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbitge(BitArray par7384, BitArray par7385)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbitgt(BitArray par7387, BitArray par7388)
		{
			throw new InvalidOperationException();
		}
		...
		public static BitArray VarbitIn(object par7390, int? par7391, int? par7392)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbitle(BitArray par7394, BitArray par7395)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbitlt(BitArray par7397, BitArray par7398)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Varbitne(BitArray par7400, BitArray par7401)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VarbitOut(BitArray par7403)
		{
			throw new InvalidOperationException();
		}
		...
		public static BitArray VarbitRecv(object par7405, int? par7406, int? par7407)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] VarbitSend(BitArray par7409)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VarbitTransform(object par7411)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Varbittypmodin(object par7413)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Varbittypmodout(int? par7415)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Varchar(string par7419, int? par7420, bool? par7421)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Varcharin(object par7423, int? par7424, int? par7425)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Varcharout(string par7427)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Varcharrecv(object par7429, int? par7430, int? par7431)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Varcharsend(string par7433)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VarcharTransform(object par7435)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Varchartypmodin(object par7437)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Varchartypmodout(int? par7439)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? Variance<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par7451)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? VarPop<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par7463)
		{
			throw new InvalidOperationException();
		}
		...
		public static decimal? VarSamp<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, decimal?>> par7475)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VoidIn(object par7477)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VoidOut(object par7479)
		{
			throw new InvalidOperationException();
		}
		...
		public static object VoidRecv(object par7480)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] VoidSend(object par7482)
		{
			throw new InvalidOperationException();
		}
		...
		public static double? Width(NpgsqlBox? par7484)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? WidthBucket(object par7496, object par7497)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1250ToLatin2(int? par7498, int? par7499, object par7500, object par7501, int? par7502)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1250ToMic(int? par7503, int? par7504, object par7505, object par7506, int? par7507)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1251ToIso(int? par7508, int? par7509, object par7510, object par7511, int? par7512)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1251ToKoi8r(int? par7513, int? par7514, object par7515, object par7516, int? par7517)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1251ToMic(int? par7518, int? par7519, object par7520, object par7521, int? par7522)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win1251ToWin866(int? par7523, int? par7524, object par7525, object par7526, int? par7527)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win866ToIso(int? par7528, int? par7529, object par7530, object par7531, int? par7532)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win866ToKoi8r(int? par7533, int? par7534, object par7535, object par7536, int? par7537)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win866ToMic(int? par7538, int? par7539, object par7540, object par7541, int? par7542)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Win866ToWin1251(int? par7543, int? par7544, object par7545, object par7546, int? par7547)
		{
			throw new InvalidOperationException();
		}
		...
		public static object WinToUtf8(int? par7548, int? par7549, object par7550, object par7551, int? par7552)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xideq(int? par7554, int? par7555)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xideqint4(int? par7557, int? par7558)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Xidin(object par7560)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xidneq(int? par7562, int? par7563)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xidneqint4(int? par7565, int? par7566)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Xidout(int? par7568)
		{
			throw new InvalidOperationException();
		}
		...
		public static int? Xidrecv(object par7570)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] Xidsend(int? par7572)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Xml(string par7574)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Xmlagg<TSource>(this IEnumerable<TSource> src, Expression<Func<TSource, string>> par7576)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Xmlcomment(string par7578)
		{
			throw new InvalidOperationException();
		}
		...
		public static string Xmlconcat2(string par7580, string par7581)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xmlexists(string par7583, string par7584)
		{
			throw new InvalidOperationException();
		}
		...
		public static string XmlIn(object par7586)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? XmlIsWellFormed(string par7588)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? XmlIsWellFormedContent(string par7590)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? XmlIsWellFormedDocument(string par7592)
		{
			throw new InvalidOperationException();
		}
		...
		public static object XmlOut(string par7594)
		{
			throw new InvalidOperationException();
		}
		...
		public static string XmlRecv(object par7596)
		{
			throw new InvalidOperationException();
		}
		...
		public static byte[] XmlSend(string par7598)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? Xmlvalidate(string par7600, string par7601)
		{
			throw new InvalidOperationException();
		}
		...
		public static object Xpath(string par7607, string par7608)
		{
			throw new InvalidOperationException();
		}
		...
		public static bool? XpathExists(string par7614, string par7615)
		{
			throw new InvalidOperationException();
		}
	...
	{
		public static Card Find(this ITable<Card> table, int Id)
		{
		...
		public static Genders Find(this ITable<Genders> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static Products Find(this ITable<Products> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static Users Find(this ITable<Users> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
